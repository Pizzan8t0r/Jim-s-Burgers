const APP_PREFIX = 'Jim-s-Burgers';     
const VERSION = 'version_01';
const CACHE_NAME = APP_PREFIX + VERSION;
// const file to cache will hold all the files we want to cache
  ...
  self.addEventListener('install', function (e) {
    e.waitUntil(
      caches.open(CACHE_NAME).then(function (cache) {
        ...
        // this line will add all the files to the cache storage instance under the cache name
        ...
        return Promise.all(
          keyList.map(function(key, i) {
            if (cacheKeeplist.indexOf(key) === -1) {
              ...
              // if this key isnt found in the keep list, delete it from the cache
